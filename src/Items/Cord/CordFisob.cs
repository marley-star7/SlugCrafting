...
public class CordFisob : Fisob
{
    ...
    public CordFisob() : base(Enums.AbstractObjectType.Cord)
    {
        ...
        RegisterUnlock(Enums.SandboxUnlockID.Cord, parent: MultiplayerUnlocks.SandboxUnlockID.PoleMimic, data: 0);
    }

    public override AbstractPhysicalObject Parse(World world, EntitySaveData saveData, SandboxUnlock? unlock)
    {
        var result = new AbstractCord(Enums.AbstractObjectType.Cord, world, saveData.Pos, saveData.ID);
        return result;
    }
