...
public class KingVultureSpearFisobs : Fisob
{
    ...
    public KingVultureSpearFisobs() : base(Enums.AbstractObjectType.KingVultureSpear)
    {
        SandboxPerformanceCost = new(linear: 0.1f, exponential: 0f);
        RegisterUnlock(Enums.SandboxUnlockID.KingVultureSpear, parent: MultiplayerUnlocks.SandboxUnlockID.KingVulture, data: 0);
    }
